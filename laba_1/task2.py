...
all_q = min(100, quantity) #получает значение меньшего из двух, это нужно для ограничения кол-ва отелей
skipped = all_q // 3

print(quantity, rank, price)
min_measure = 1000000000000 #она будет использована для хранения минимального соотношения цена/ранд
